...
const platforms = [
    ...
    { x: 2700, y: 1500, width: 250, height: 50, color: '#333', type: 'asdd' },
    { x: 2700, y: 1500, width: 250, height: 50, color: '#333', type: 'pipe_h' },
    { x: 3000, y: 1400, width: 250, height: 150, color: '#333', type: 'pipe_h' },
...
const boxy = [
    { x: 250, y: 1850, width: 50, height: 50, dx: 0, dy: 0, friction: 0.8, },
];
