...
const platforms = [
    ...
    { x: 0, y: 1300, width: 300, height: 70, color: '#333', type: 'wall' },
    { x: 300, y: 1300, width: 300, height: 70, color: '#333', type: 'wall' },
    { x: 600, y: 1300, width: 300, height: 70, color: '#333', type: 'wall' },
    { x: 900, y: 1300, width: 300, height: 70, color: '#333', type: 'wall' },
    { x: 1200, y: 1300, width: 300, height: 70, color: '#333', type: 'wall'},
    { x: 1500, y: 1300, width: 300, height: 70, color: '#333', type: 'wall' },
    { x: 1800, y: 1300, width: 300, height: 70, color: '#333', type: 'wall'},
    { x: 2100, y: 1300, width: 300, height: 70, color: '#333', type: 'wall' },
    { x: 2400, y: 1300, width: 300, height: 70, color: '#333', type: 'wall' },
    { x: 2700, y: 1300, width: 300, height: 70, color: '#333', type: 'wall' },
];
...
macky.npc.src = '../../asseti/donnie.png';
